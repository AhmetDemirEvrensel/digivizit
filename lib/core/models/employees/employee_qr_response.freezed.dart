...
/// @nodoc
mixin _$EmployeeQrResponse {

@JsonKey(name: "success") bool? get success;@JsonKey(name: "message") String? get message;@JsonKey(name: "data") List<EmployeeQrData>? get data;
/// Create a copy of EmployeeQrResponse
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$EmployeeQrResponseCopyWith<EmployeeQrResponse> get copyWith => _$EmployeeQrResponseCopyWithImpl<EmployeeQrResponse>(this as EmployeeQrResponse, _$identity);

  /// Serializes this EmployeeQrResponse to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EmployeeQrResponse&&(identical(other.success, success) || other.success == success)&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other.data, data));
}
...
@override
String toString() {
  return 'EmployeeQrResponse(success: $success, message: $message, data: $data)';
}
...
/// @nodoc
abstract mixin class $EmployeeQrResponseCopyWith<$Res>  {
  factory $EmployeeQrResponseCopyWith(EmployeeQrResponse value, $Res Function(EmployeeQrResponse) _then) = _$EmployeeQrResponseCopyWithImpl;
@useResult
$Res call({
@JsonKey(name: "success") bool? success,@JsonKey(name: "message") String? message,@JsonKey(name: "data") List<EmployeeQrData>? data
});
...
/// @nodoc
class _$EmployeeQrResponseCopyWithImpl<$Res>
    implements $EmployeeQrResponseCopyWith<$Res> {
  _$EmployeeQrResponseCopyWithImpl(this._self, this._then);

  final EmployeeQrResponse _self;
  final $Res Function(EmployeeQrResponse) _then;
...
/// Adds pattern-matching-related methods to [EmployeeQrResponse].
extension EmployeeQrResponsePatterns on EmployeeQrResponse {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _EmployeeQrResponse value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _EmployeeQrResponse() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _EmployeeQrResponse value)  $default,){
final _that = this;
switch (_that) {
case _EmployeeQrResponse():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _EmployeeQrResponse value)?  $default,){
final _that = this;
switch (_that) {
case _EmployeeQrResponse() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "success")  bool? success, @JsonKey(name: "message")  String? message, @JsonKey(name: "data")  List<EmployeeQrData>? data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EmployeeQrResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "success")  bool? success, @JsonKey(name: "message")  String? message, @JsonKey(name: "data")  List<EmployeeQrData>? data)  $default,) {final _that = this;
switch (_that) {
case _EmployeeQrResponse():
return $default(_that.success,_that.message,_that.data);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "success")  bool? success, @JsonKey(name: "message")  String? message, @JsonKey(name: "data")  List<EmployeeQrData>? data)?  $default,) {final _that = this;
switch (_that) {
case _EmployeeQrResponse() when $default != null:
return $default(_that.success,_that.message,_that.data);case _:
  return null;
...
class _EmployeeQrResponse implements EmployeeQrResponse {
  const _EmployeeQrResponse({@JsonKey(name: "success") this.success, @JsonKey(name: "message") this.message, @JsonKey(name: "data") final  List<EmployeeQrData>? data}): _data = data;
  factory _EmployeeQrResponse.fromJson(Map<String, dynamic> json) => _$EmployeeQrResponseFromJson(json);

@override@JsonKey(name: "success") final  bool? success;
@override@JsonKey(name: "message") final  String? message;
 final  List<EmployeeQrData>? _data;
@override@JsonKey(name: "data") List<EmployeeQrData>? get data {
  final value = _data;
...
@pragma('vm:prefer-inline')
_$EmployeeQrResponseCopyWith<_EmployeeQrResponse> get copyWith => __$EmployeeQrResponseCopyWithImpl<_EmployeeQrResponse>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$EmployeeQrResponseToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _EmployeeQrResponse&&(identical(other.success, success) || other.success == success)&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other._data, _data));
}
...
/// @nodoc
abstract mixin class _$EmployeeQrResponseCopyWith<$Res> implements $EmployeeQrResponseCopyWith<$Res> {
  factory _$EmployeeQrResponseCopyWith(_EmployeeQrResponse value, $Res Function(_EmployeeQrResponse) _then) = __$EmployeeQrResponseCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: "success") bool? success,@JsonKey(name: "message") String? message,@JsonKey(name: "data") List<EmployeeQrData>? data
});
...
/// @nodoc
class __$EmployeeQrResponseCopyWithImpl<$Res>
    implements _$EmployeeQrResponseCopyWith<$Res> {
  __$EmployeeQrResponseCopyWithImpl(this._self, this._then);

  final _EmployeeQrResponse _self;
  final $Res Function(_EmployeeQrResponse) _then;

/// Create a copy of EmployeeQrResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? success = freezed,Object? message = freezed,Object? data = freezed,}) {
  return _then(_EmployeeQrResponse(
success: freezed == success ? _self.success : success // ignore: cast_nullable_to_non_nullable
as bool?,message: freezed == message ? _self.message : message // ignore: cast_nullable_to_non_nullable
...
as Photo?,firmName: freezed == firmName ? _self.firmName : firmName // ignore: cast_nullable_to_non_nullable
as FirmName?,officeAddress: freezed == officeAddress ? _self.officeAddress : officeAddress // ignore: cast_nullable_to_non_nullable
as OfficeAddress?,media: freezed == media ? _self.media : media // ignore: cast_nullable_to_non_nullable
as List<Photo>?,qrPhotoUrl: freezed == qrPhotoUrl ? _self.qrPhotoUrl : qrPhotoUrl // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [EmployeeQrData].
extension EmployeeQrDataPatterns on EmployeeQrData {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _EmployeeQrData value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _EmployeeQrData() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _EmployeeQrData value)  $default,){
final _that = this;
switch (_that) {
case _EmployeeQrData():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _EmployeeQrData value)?  $default,){
final _that = this;
switch (_that) {
case _EmployeeQrData() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "id")  int? id, @JsonKey(name: "user_id")  int? userId, @JsonKey(name: "title")  String? title, @JsonKey(name: "email")  String? email, @JsonKey(name: "phone")  String? phone, @JsonKey(name: "extension_number")  String? extensionNumber, @JsonKey(name: "qr")  int? qr, @JsonKey(name: "qr_code_url")  String? qrCodeUrl, @JsonKey(name: "instagram_url")  dynamic instagramUrl, @JsonKey(name: "linkedin_url")  dynamic linkedinUrl, @JsonKey(name: "appointment_status")  String? appointmentStatus, @JsonKey(name: "date")  DateTime? date, @JsonKey(name: "status")  String? status, @JsonKey(name: "slug")  String? slug, @JsonKey(name: "created_at")  DateTime? createdAt, @JsonKey(name: "updated_at")  DateTime? updatedAt, @JsonKey(name: "deleted_at")  dynamic deletedAt, @JsonKey(name: "firm_name_id")  int? firmNameId, @JsonKey(name: "department_id")  int? departmentId, @JsonKey(name: "office_address_id")  int? officeAddressId, @JsonKey(name: "title_en")  String? titleEn, @JsonKey(name: "department")  Department? department, @JsonKey(name: "department_en")  dynamic departmentEn, @JsonKey(name: "photo")  Photo? photo, @JsonKey(name: "qr_photo")  Photo? qrPhoto, @JsonKey(name: "firm_name")  FirmName? firmName, @JsonKey(name: "office_address")  OfficeAddress? officeAddress, @JsonKey(name: "media")  List<Photo>? media, @JsonKey(name: "qr_photo_url")  String? qrPhotoUrl, @JsonKey(name: "qr_photo_thumbnail")  String? qrPhotoThumbnail, @JsonKey(name: "qr_photo_preview")  String? qrPhotoPreview)  $default,) {final _that = this;
switch (_that) {
case _EmployeeQrData():
return $default(_that.id,_that.userId,_that.title,_that.email,_that.phone,_that.extensionNumber,_that.qr,_that.qrCodeUrl,_that.instagramUrl,_that.linkedinUrl,_that.appointmentStatus,_that.date,_that.status,_that.slug,_that.createdAt,_that.updatedAt,_that.deletedAt,_that.firmNameId,_that.departmentId,_that.officeAddressId,_that.titleEn,_that.department,_that.departmentEn,_that.photo,_that.qrPhoto,_that.firmName,_that.officeAddress,_that.media,_that.qrPhotoUrl,_that.qrPhotoThumbnail,_that.qrPhotoPreview);case _:
  throw StateError('Unexpected subclass');
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$EmployeeQrDataCopyWith<_EmployeeQrData> get copyWith => __$EmployeeQrDataCopyWithImpl<_EmployeeQrData>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$EmployeeQrDataToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _EmployeeQrData&&(identical(other.id, id) || other.id == id)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.title, title) || other.title == title)&&(identical(other.email, email) || other.email == email)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.extensionNumber, extensionNumber) || other.extensionNumber == extensionNumber)&&(identical(other.qr, qr) || other.qr == qr)&&(identical(other.qrCodeUrl, qrCodeUrl) || other.qrCodeUrl == qrCodeUrl)&&const DeepCollectionEquality().equals(other.instagramUrl, instagramUrl)&&const DeepCollectionEquality().equals(other.linkedinUrl, linkedinUrl)&&(identical(other.appointmentStatus, appointmentStatus) || other.appointmentStatus == appointmentStatus)&&(identical(other.date, date) || other.date == date)&&(identical(other.status, status) || other.status == status)&&(identical(other.slug, slug) || other.slug == slug)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&const DeepCollectionEquality().equals(other.deletedAt, deletedAt)&&(identical(other.firmNameId, firmNameId) || other.firmNameId == firmNameId)&&(identical(other.departmentId, departmentId) || other.departmentId == departmentId)&&(identical(other.officeAddressId, officeAddressId) || other.officeAddressId == officeAddressId)&&(identical(other.titleEn, titleEn) || other.titleEn == titleEn)&&(identical(other.department, department) || other.department == department)&&const DeepCollectionEquality().equals(other.departmentEn, departmentEn)&&(identical(other.photo, photo) || other.photo == photo)&&(identical(other.qrPhoto, qrPhoto) || other.qrPhoto == qrPhoto)&&(identical(other.firmName, firmName) || other.firmName == firmName)&&(identical(other.officeAddress, officeAddress) || other.officeAddress == officeAddress)&&const DeepCollectionEquality().equals(other._media, _media)&&(identical(other.qrPhotoUrl, qrPhotoUrl) || other.qrPhotoUrl == qrPhotoUrl)&&(identical(other.qrPhotoThumbnail, qrPhotoThumbnail) || other.qrPhotoThumbnail == qrPhotoThumbnail)&&(identical(other.qrPhotoPreview, qrPhotoPreview) || other.qrPhotoPreview == qrPhotoPreview));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,title,email,phone,extensionNumber,qr,qrCodeUrl,const DeepCollectionEquality().hash(instagramUrl),const DeepCollectionEquality().hash(linkedinUrl),appointmentStatus,date,status,slug,createdAt,updatedAt,const DeepCollectionEquality().hash(deletedAt),firmNameId,departmentId,officeAddressId,titleEn,department,const DeepCollectionEquality().hash(departmentEn),photo,qrPhoto,firmName,officeAddress,const DeepCollectionEquality().hash(_media),qrPhotoUrl,qrPhotoThumbnail,qrPhotoPreview]);
...
/// @nodoc
abstract mixin class _$EmployeeQrDataCopyWith<$Res> implements $EmployeeQrDataCopyWith<$Res> {
  factory _$EmployeeQrDataCopyWith(_EmployeeQrData value, $Res Function(_EmployeeQrData) _then) = __$EmployeeQrDataCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: "id") int? id,@JsonKey(name: "user_id") int? userId,@JsonKey(name: "title") String? title,@JsonKey(name: "email") String? email,@JsonKey(name: "phone") String? phone,@JsonKey(name: "extension_number") String? extensionNumber,@JsonKey(name: "qr") int? qr,@JsonKey(name: "qr_code_url") String? qrCodeUrl,@JsonKey(name: "instagram_url") dynamic instagramUrl,@JsonKey(name: "linkedin_url") dynamic linkedinUrl,@JsonKey(name: "appointment_status") String? appointmentStatus,@JsonKey(name: "date") DateTime? date,@JsonKey(name: "status") String? status,@JsonKey(name: "slug") String? slug,@JsonKey(name: "created_at") DateTime? createdAt,@JsonKey(name: "updated_at") DateTime? updatedAt,@JsonKey(name: "deleted_at") dynamic deletedAt,@JsonKey(name: "firm_name_id") int? firmNameId,@JsonKey(name: "department_id") int? departmentId,@JsonKey(name: "office_address_id") int? officeAddressId,@JsonKey(name: "title_en") String? titleEn,@JsonKey(name: "department") Department? department,@JsonKey(name: "department_en") dynamic departmentEn,@JsonKey(name: "photo") Photo? photo,@JsonKey(name: "qr_photo") Photo? qrPhoto,@JsonKey(name: "firm_name") FirmName? firmName,@JsonKey(name: "office_address") OfficeAddress? officeAddress,@JsonKey(name: "media") List<Photo>? media,@JsonKey(name: "qr_photo_url") String? qrPhotoUrl,@JsonKey(name: "qr_photo_thumbnail") String? qrPhotoThumbnail,@JsonKey(name: "qr_photo_preview") String? qrPhotoPreview
});
...
@override $DepartmentCopyWith<$Res>? get department;@override $PhotoCopyWith<$Res>? get photo;@override $PhotoCopyWith<$Res>? get qrPhoto;@override $FirmNameCopyWith<$Res>? get firmName;@override $OfficeAddressCopyWith<$Res>? get officeAddress;

}
/// @nodoc
class __$EmployeeQrDataCopyWithImpl<$Res>
    implements _$EmployeeQrDataCopyWith<$Res> {
  __$EmployeeQrDataCopyWithImpl(this._self, this._then);

  final _EmployeeQrData _self;
  final $Res Function(_EmployeeQrData) _then;
...
as Photo?,firmName: freezed == firmName ? _self.firmName : firmName // ignore: cast_nullable_to_non_nullable
as FirmName?,officeAddress: freezed == officeAddress ? _self.officeAddress : officeAddress // ignore: cast_nullable_to_non_nullable
as OfficeAddress?,media: freezed == media ? _self._media : media // ignore: cast_nullable_to_non_nullable
as List<Photo>?,qrPhotoUrl: freezed == qrPhotoUrl ? _self.qrPhotoUrl : qrPhotoUrl // ignore: cast_nullable_to_non_nullable
as String?,qrPhotoThumbnail: freezed == qrPhotoThumbnail ? _self.qrPhotoThumbnail : qrPhotoThumbnail // ignore: cast_nullable_to_non_nullable
as String?,qrPhotoPreview: freezed == qrPhotoPreview ? _self.qrPhotoPreview : qrPhotoPreview // ignore: cast_nullable_to_non_nullable
as String?,
...
as GeneratedConversionsClass?,responsiveImages: freezed == responsiveImages ? _self.responsiveImages : responsiveImages // ignore: cast_nullable_to_non_nullable
...
as List<dynamic>?,generatedConversions: freezed == generatedConversions ? _self.generatedConversions : generatedConversions // ignore: cast_nullable_to_non_nullable
as GeneratedConversionsClass?,responsiveImages: freezed == responsiveImages ? _self._responsiveImages : responsiveImages // ignore: cast_nullable_to_non_nullable
as List<dynamic>?,orderColumn: freezed == orderColumn ? _self.orderColumn : orderColumn // ignore: cast_nullable_to_non_nullable
as int?,createdAt: freezed == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime?,updatedAt: freezed == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,originalUrl: freezed == originalUrl ? _self.originalUrl : originalUrl // ignore: cast_nullable_to_non_nullable
...
class _GeneratedConversionsClass implements GeneratedConversionsClass {
  const _GeneratedConversionsClass({@JsonKey(name: "thumb") this.thumb, @JsonKey(name: "preview") this.preview});
...
@useResult
$Res call({
@JsonKey(name: "id") int? id,@JsonKey(name: "firm_name") String? firmName,@JsonKey(name: "website") String? website,@JsonKey(name: "instagram_url") String? instagramUrl,@JsonKey(name: "linkedin_url") String? linkedinUrl,@JsonKey(name: "youtube_video_url") String? youtubeVideoUrl,@JsonKey(name: "created_at") DateTime? createdAt,@JsonKey(name: "updated_at") DateTime? updatedAt,@JsonKey(name: "deleted_at") dynamic deletedAt,@JsonKey(name: "logo") Photo? logo,@JsonKey(name: "main_background") Photo? mainBackground,@JsonKey(name: "catalog_tr") Catalog? catalogTr,@JsonKey(name: "catalog_en") Catalog? catalogEn,@JsonKey(name: "media") List<Media>? media
});


$PhotoCopyWith<$Res>? get logo;$PhotoCopyWith<$Res>? get mainBackground;$CatalogCopyWith<$Res>? get catalogTr;$CatalogCopyWith<$Res>? get catalogEn;
...
/// Create a copy of FirmName
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? firmName = freezed,Object? website = freezed,Object? instagramUrl = freezed,Object? linkedinUrl = freezed,Object? youtubeVideoUrl = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? deletedAt = freezed,Object? logo = freezed,Object? mainBackground = freezed,Object? catalogTr = freezed,Object? catalogEn = freezed,Object? media = freezed,}) {
  return _then(_self.copyWith(
id: freezed == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
as DateTime?,updatedAt: freezed == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,deletedAt: freezed == deletedAt ? _self.deletedAt : deletedAt // ignore: cast_nullable_to_non_nullable
as dynamic,logo: freezed == logo ? _self.logo : logo // ignore: cast_nullable_to_non_nullable
as Photo?,mainBackground: freezed == mainBackground ? _self.mainBackground : mainBackground // ignore: cast_nullable_to_non_nullable
as Photo?,catalogTr: freezed == catalogTr ? _self.catalogTr : catalogTr // ignore: cast_nullable_to_non_nullable
as Catalog?,catalogEn: freezed == catalogEn ? _self.catalogEn : catalogEn // ignore: cast_nullable_to_non_nullable
as Catalog?,media: freezed == media ? _self.media : media // ignore: cast_nullable_to_non_nullable
as List<Media>?,
  ));
}
/// Create a copy of FirmName
...
@override
@pragma('vm:prefer-inline')
$PhotoCopyWith<$Res>? get logo {
    if (_self.logo == null) {
    return null;
  }

  return $PhotoCopyWith<$Res>(_self.logo!, (value) {
...
@override
@pragma('vm:prefer-inline')
$PhotoCopyWith<$Res>? get mainBackground {
    if (_self.mainBackground == null) {
    return null;
  }

  return $PhotoCopyWith<$Res>(_self.mainBackground!, (value) {
...
class _FirmName implements FirmName {
  const _FirmName({@JsonKey(name: "id") this.id, @JsonKey(name: "firm_name") this.firmName, @JsonKey(name: "website") this.website, @JsonKey(name: "instagram_url") this.instagramUrl, @JsonKey(name: "linkedin_url") this.linkedinUrl, @JsonKey(name: "youtube_video_url") this.youtubeVideoUrl, @JsonKey(name: "created_at") this.createdAt, @JsonKey(name: "updated_at") this.updatedAt, @JsonKey(name: "deleted_at") this.deletedAt, @JsonKey(name: "logo") this.logo, @JsonKey(name: "main_background") this.mainBackground, @JsonKey(name: "catalog_tr") this.catalogTr, @JsonKey(name: "catalog_en") this.catalogEn, @JsonKey(name: "media") final  List<Media>? media}): _media = media;
...
@override@JsonKey(name: "updated_at") final  DateTime? updatedAt;
@override@JsonKey(name: "deleted_at") final  dynamic deletedAt;
@override@JsonKey(name: "logo") final  Photo? logo;
@override@JsonKey(name: "main_background") final  Photo? mainBackground;
...
@override $PhotoCopyWith<$Res>? get logo;@override $PhotoCopyWith<$Res>? get mainBackground;@override $CatalogCopyWith<$Res>? get catalogTr;@override $CatalogCopyWith<$Res>? get catalogEn;
...
/// Create a copy of FirmName
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? firmName = freezed,Object? website = freezed,Object? instagramUrl = freezed,Object? linkedinUrl = freezed,Object? youtubeVideoUrl = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? deletedAt = freezed,Object? logo = freezed,Object? mainBackground = freezed,Object? catalogTr = freezed,Object? catalogEn = freezed,Object? media = freezed,}) {
...
as Photo?,catalogTr: freezed == catalogTr ? _self.catalogTr : catalogTr // ignore: cast_nullable_to_non_nullable
as Catalog?,catalogEn: freezed == catalogEn ? _self.catalogEn : catalogEn // ignore: cast_nullable_to_non_nullable
as Catalog?,media: freezed == media ? _self._media : media // ignore: cast_nullable_to_non_nullable
as List<Media>?,
  ));
}
...
/// Create a copy of Catalog
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? modelType = freezed,Object? modelId = freezed,Object? uuid = freezed,Object? collectionName = freezed,Object? name = freezed,Object? fileName = freezed,Object? mimeType = freezed,Object? disk = freezed,Object? conversionsDisk = freezed,Object? size = freezed,Object? manipulations = freezed,Object? customProperties = freezed,Object? generatedConversions = freezed,Object? responsiveImages = freezed,Object? orderColumn = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? originalUrl = freezed,Object? previewUrl = freezed,}) {
  return _then(_self.copyWith(
id: freezed == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int?,modelType: freezed == modelType ? _self.modelType : modelType // ignore: cast_nullable_to_non_nullable
as String?,modelId: freezed == modelId ? _self.modelId : modelId // ignore: cast_nullable_to_non_nullable
...
as List<dynamic>?,customProperties: freezed == customProperties ? _self.customProperties : customProperties // ignore: cast_nullable_to_non_nullable
as List<dynamic>?,generatedConversions: freezed == generatedConversions ? _self.generatedConversions : generatedConversions // ignore: cast_nullable_to_non_nullable
as List<dynamic>?,responsiveImages: freezed == responsiveImages ? _self.responsiveImages : responsiveImages // ignore: cast_nullable_to_non_nullable
as List<dynamic>?,orderColumn: freezed == orderColumn ? _self.orderColumn : orderColumn // ignore: cast_nullable_to_non_nullable
as int?,createdAt: freezed == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime?,updatedAt: freezed == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,originalUrl: freezed == originalUrl ? _self.originalUrl : originalUrl // ignore: cast_nullable_to_non_nullable
...
class _Catalog implements Catalog {
  const _Catalog({@JsonKey(name: "id") this.id, @JsonKey(name: "model_type") this.modelType, @JsonKey(name: "model_id") this.modelId, @JsonKey(name: "uuid") this.uuid, @JsonKey(name: "collection_name") this.collectionName, @JsonKey(name: "name") this.name, @JsonKey(name: "file_name") this.fileName, @JsonKey(name: "mime_type") this.mimeType, @JsonKey(name: "disk") this.disk, @JsonKey(name: "conversions_disk") this.conversionsDisk, @JsonKey(name: "size") this.size, @JsonKey(name: "manipulations") final  List<dynamic>? manipulations, @JsonKey(name: "custom_properties") final  List<dynamic>? customProperties, @JsonKey(name: "generated_conversions") final  List<dynamic>? generatedConversions, @JsonKey(name: "responsive_images") final  List<dynamic>? responsiveImages, @JsonKey(name: "order_column") this.orderColumn, @JsonKey(name: "created_at") this.createdAt, @JsonKey(name: "updated_at") this.updatedAt, @JsonKey(name: "original_url") this.originalUrl, @JsonKey(name: "preview_url") this.previewUrl}): _manipulations = manipulations,_customProperties = customProperties,_generatedConversions = generatedConversions,_responsiveImages = responsiveImages;
...
as int?,manipulations: freezed == manipulations ? _self._manipulations : manipulations // ignore: cast_nullable_to_non_nullable
as List<dynamic>?,customProperties: freezed == customProperties ? _self._customProperties : customProperties // ignore: cast_nullable_to_non_nullable
as List<dynamic>?,generatedConversions: freezed == generatedConversions ? _self._generatedConversions : generatedConversions // ignore: cast_nullable_to_non_nullable
as List<dynamic>?,responsiveImages: freezed == responsiveImages ? _self._responsiveImages : responsiveImages // ignore: cast_nullable_to_non_nullable
as List<dynamic>?,orderColumn: freezed == orderColumn ? _self.orderColumn : orderColumn // ignore: cast_nullable_to_non_nullable
as int?,createdAt: freezed == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime?,updatedAt: freezed == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,originalUrl: freezed == originalUrl ? _self.originalUrl : originalUrl // ignore: cast_nullable_to_non_nullable
...
/// Create a copy of Media
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? modelType = freezed,Object? modelId = freezed,Object? uuid = freezed,Object? collectionName = freezed,Object? name = freezed,Object? fileName = freezed,Object? mimeType = freezed,Object? disk = freezed,Object? conversionsDisk = freezed,Object? size = freezed,Object? manipulations = freezed,Object? customProperties = freezed,Object? generatedConversions = freezed,Object? responsiveImages = freezed,Object? orderColumn = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? url = freezed,Object? thumbnail = freezed,Object? preview = freezed,Object? originalUrl = freezed,Object? previewUrl = freezed,}) {
  return _then(_self.copyWith(
id: freezed == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int?,modelType: freezed == modelType ? _self.modelType : modelType // ignore: cast_nullable_to_non_nullable
as String?,modelId: freezed == modelId ? _self.modelId : modelId // ignore: cast_nullable_to_non_nullable
...
as List<dynamic>?,customProperties: freezed == customProperties ? _self.customProperties : customProperties // ignore: cast_nullable_to_non_nullable
as List<dynamic>?,generatedConversions: freezed == generatedConversions ? _self.generatedConversions : generatedConversions // ignore: cast_nullable_to_non_nullable
as dynamic,responsiveImages: freezed == responsiveImages ? _self.responsiveImages : responsiveImages // ignore: cast_nullable_to_non_nullable
as List<dynamic>?,orderColumn: freezed == orderColumn ? _self.orderColumn : orderColumn // ignore: cast_nullable_to_non_nullable
as int?,createdAt: freezed == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime?,updatedAt: freezed == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
...
class _Media implements Media {
  const _Media({@JsonKey(name: "id") this.id, @JsonKey(name: "model_type") this.modelType, @JsonKey(name: "model_id") this.modelId, @JsonKey(name: "uuid") this.uuid, @JsonKey(name: "collection_name") this.collectionName, @JsonKey(name: "name") this.name, @JsonKey(name: "file_name") this.fileName, @JsonKey(name: "mime_type") this.mimeType, @JsonKey(name: "disk") this.disk, @JsonKey(name: "conversions_disk") this.conversionsDisk, @JsonKey(name: "size") this.size, @JsonKey(name: "manipulations") final  List<dynamic>? manipulations, @JsonKey(name: "custom_properties") final  List<dynamic>? customProperties, @JsonKey(name: "generated_conversions") this.generatedConversions, @JsonKey(name: "responsive_images") final  List<dynamic>? responsiveImages, @JsonKey(name: "order_column") this.orderColumn, @JsonKey(name: "created_at") this.createdAt, @JsonKey(name: "updated_at") this.updatedAt, @JsonKey(name: "url") this.url, @JsonKey(name: "thumbnail") this.thumbnail, @JsonKey(name: "preview") this.preview, @JsonKey(name: "original_url") this.originalUrl, @JsonKey(name: "preview_url") this.previewUrl}): _manipulations = manipulations,_customProperties = customProperties,_responsiveImages = responsiveImages;
...
as List<dynamic>?,customProperties: freezed == customProperties ? _self._customProperties : customProperties // ignore: cast_nullable_to_non_nullable
as List<dynamic>?,generatedConversions: freezed == generatedConversions ? _self.generatedConversions : generatedConversions // ignore: cast_nullable_to_non_nullable
as dynamic,responsiveImages: freezed == responsiveImages ? _self._responsiveImages : responsiveImages // ignore: cast_nullable_to_non_nullable
as List<dynamic>?,orderColumn: freezed == orderColumn ? _self.orderColumn : orderColumn // ignore: cast_nullable_to_non_nullable
as int?,createdAt: freezed == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime?,updatedAt: freezed == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,url: freezed == url ? _self.url : url // ignore: cast_nullable_to_non_nullable
...
/// Create a copy of OfficeAddress
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? addressName = freezed,Object? streetAddress = freezed,Object? phone = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? deletedAt = freezed,}) {
  return _then(_self.copyWith(
id: freezed == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
class _OfficeAddress implements OfficeAddress {
  const _OfficeAddress({@JsonKey(name: "id") this.id, @JsonKey(name: "address_name") this.addressName, @JsonKey(name: "street_address") this.streetAddress, @JsonKey(name: "phone") this.phone, @JsonKey(name: "created_at") this.createdAt, @JsonKey(name: "updated_at") this.updatedAt, @JsonKey(name: "deleted_at") this.deletedAt});
...
/// Create a copy of OfficeAddress
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? addressName = freezed,Object? streetAddress = freezed,Object? phone = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? deletedAt = freezed,}) {
