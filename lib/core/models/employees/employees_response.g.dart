...
_EmployeesResponse _$EmployeesResponseFromJson(Map<String, dynamic> json) =>
    _EmployeesResponse(
...
Map<String, dynamic> _$EmployeesResponseToJson(_EmployeesResponse instance) =>
    <String, dynamic>{
...
_Department _$DepartmentFromJson(Map<String, dynamic> json) => _Department(
  ...
  bannerBackground: json['banner_background'] == null
      ? null
      : QrPhoto.fromJson(json['banner_background'] as Map<String, dynamic>),
  media: (json['media'] as List<dynamic>)
      .map((e) => QrPhoto.fromJson(e as Map<String, dynamic>))
      .toList(),
);
