...
@override
String toString() {
  return 'PageMeta(currentPage: $currentPage, lastPage: $lastPage, perPage: $perPage, total: $total)';
}
...
class _PageMeta implements PageMeta {
  const _PageMeta({@JsonKey(name: "current_page") this.currentPage, @JsonKey(name: "last_page") this.lastPage, @JsonKey(name: "per_page") this.perPage, @JsonKey(name: "total") this.total});
