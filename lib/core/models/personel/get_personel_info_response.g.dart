...
_GetPersonelInfoResponse _$GetPersonelInfoResponseFromJson(
...
Map<String, dynamic> _$GetPersonelInfoResponseToJson(
  _GetPersonelInfoResponse instance,
) => <String, dynamic>{
...
_Datum _$DatumFromJson(Map<String, dynamic> json) => _Datum(
  ...
  photo: json['photo'] == null
      ? null
      : QrPhoto.fromJson(json['photo'] as Map<String, dynamic>),
  qrPhoto: QrPhoto.fromJson(json['qr_photo'] as Map<String, dynamic>),
  firmName: FirmName.fromJson(json['firm_name'] as Map<String, dynamic>),
  officeAddress: OfficeAddress.fromJson(
    json['office_address'] as Map<String, dynamic>,
  ),
  media: (json['media'] as List<dynamic>)
      .map((e) => QrPhoto.fromJson(e as Map<String, dynamic>))
      .toList(),
);
...
_Department _$DepartmentFromJson(Map<String, dynamic> json) => _Department(
  ...
  updatedAt: DateTime.parse(json['updated_at'] as String),
  deletedAt: json['deleted_at'],
  bannerBackground: QrPhoto.fromJson(
...
_QrPhoto _$QrPhotoFromJson(Map<String, dynamic> json) => _QrPhoto(
  id: (json['id'] as num).toInt(),
...
Map<String, dynamic> _$QrPhotoToJson(_QrPhoto instance) => <String, dynamic>{
  'id': instance.id,
...
_FirmName _$FirmNameFromJson(Map<String, dynamic> json) => _FirmName(
  ...
  updatedAt: DateTime.parse(json['updated_at'] as String),
  deletedAt: json['deleted_at'],
  logo: QrPhoto.fromJson(json['logo'] as Map<String, dynamic>),
  mainBackground: QrPhoto.fromJson(
    json['main_background'] as Map<String, dynamic>,
  ),
  catalogTr: Catalog.fromJson(json['catalog_tr'] as Map<String, dynamic>),
  catalogEn: Catalog.fromJson(json['catalog_en'] as Map<String, dynamic>),
  media: (json['media'] as List<dynamic>)
