...
import 'package:digivizit/shared/components/loader/animation_controller_utils.dart';
import 'package:digivizit/shared/components/loader/draw_dot.dart';

class FourRotatingDots extends StatefulWidget {
  final double? size;
  final Color? color;

  FourRotatingDots({super.key, this.color = AppColors.primary700, this.size});
...
class _FourRotatingDotsState extends State<FourRotatingDots>
  ...
  Widget build(BuildContext context) {
    final double size = widget.size ?? appSizer.px(45, Axis.horizontal);
